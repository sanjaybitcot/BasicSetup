  domainPath="http://127.0.0.1:8000";
  var ai_cart = [];
  ...
  {  
   ...
   setTimeout(function(){ owl_carousel_trigger(); }, 1000);
  }
    ...
    if(shopStatus.data.store_status == 1)
    {
        ...
        if(ai_template =="product" || ai_template =="cart" || ai_template =="thankyou")
        {
            function addCSS(t)
            {
            ...
            var widgetList = {product:1,cart:4,thankyou:5};
            ...
            if(typeof frontendStatus.data.widgets_lists_id_8 != 'undefined')
            {
              if(frontendStatus.data.widgets_lists_id_8.status == 1)
              {    
                var product_r="<div class='ai_newly_arrived_product_title ai_cross_sell_related_title'>  <h3 "+frontendStatus.data.layout_heading_style+">"+frontendStatus.data.widgets_lists_id_8.title+"</h3></div><div class='"+layoutView+" earning_grid_slider' id='ai_newly_arrived_product_list'>"+frontendStatus.data.widgets_lists_id_8.product_list+"</div>";
                document.getElementById("CrossSellNewTopProducts").innerHTML +=product_r;
              }
            }

            if(typeof frontendStatus.data.widgets_lists_id_6 != 'undefined')
            {
              if(frontendStatus.data.widgets_lists_id_6.status == 1)
              {     
                var product_r="<div class='ai_top_selling_product_title ai_cross_sell_related_title'>  <h3 "+frontendStatus.data.layout_heading_style+">"+frontendStatus.data.widgets_lists_id_6.title+"</h3></div><div class='"+layoutView+" earning_grid_slider' id='ai_top_selling_product_list'>"+frontendStatus.data.widgets_lists_id_6.product_list+"</div>";
                document.getElementById("CrossSellNewTopProducts").innerHTML +=product_r;
              }
            }
            ...
            owl_carousel_trigger();
            function owl_carousel_trigger(){
                $(function() 
                { 
